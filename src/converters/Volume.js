...
import volumeBackground from '../SVG/volumebackground.svg'
import Row from '../Row';
import '../App.css'
...
export default function Converter() {
    ...
    const [firstRowUnit, setFirstRowUnit] = useState("ml");
    const [secondRowUnit, setSecondRowUnit] = useState("l");
    ...
    useEffect(() => {
        setUnitsList(convert().possibilities("volume"));
    }, []);
    ...
    return (
        <>
                ...
                <div className="conversionPanel">
                    <div className="rowWrapper">
                        <Row
                            ...
                            unitChange={e => setFirstRowUnit(e.target.value)} // UPDATES THE VOLUME ROW WHEN USER CHOOSES A DIFFERENT ONE
                        ...
                        <Row
                            ...
                            unitChange={e => setSecondRowUnit(e.target.value)} // UPDATES THE VOLUME ROW WHEN USER CHOOSES A DIFFERENT ONE
            ...
            <div className="decoration" style={{backgroundImage: `url(${volumeBackground})`}}></div>
        </>
    );
}