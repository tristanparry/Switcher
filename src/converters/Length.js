...
import lengthBackground from '../SVG/lengthbackground.svg'
import Row from '../Row';
import '../App.css'
...
export default function Converter() {
    ...
    const [firstRowUnit, setFirstRowUnit] = useState("cm");
    const [secondRowUnit, setSecondRowUnit] = useState("m");
    ...
    useEffect(() => {
        setUnitsList(convert().possibilities("length"));
    }, []);
    ...
    return (
        <>
                ...
                <div className="conversionPanel">
                    <div className="rowWrapper">
                        <Row
                            ...
                            unitChange={e => setFirstRowUnit(e.target.value)} // UPDATES THE LENGTH ROW WHEN USER CHOOSES A DIFFERENT ONE
                        ...
                        <Row
                            ...
                            unitChange={e => setSecondRowUnit(e.target.value)} // UPDATES THE LENGTH ROW WHEN USER CHOOSES A DIFFERENT ONE
            ...
            <div className="decoration" style={{ backgroundImage: `url(${lengthBackground})` }}></div>
        </>
    );
}